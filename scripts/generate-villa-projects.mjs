...
const loadersFile = path.join(root, "lib", "exterior-villa-gallery-loaders.ts");
...
writeGeneratedProjectModules({
  banner: "scripts/generate-villa-projects.mjs",
  projectsFile: outFile,
  loadersFile,
  loadersExportName: "villaGalleryLoaders",
  coverImportLines,
  projectsConstName: "villaProjects",
  projectBlocks,
  galleryEntries,
});
