"""Create temporary placeholder residential building images for project 07."""
from pathlib import Path

from PIL import Image, ImageDraw, ImageFont

root = Path(r"imgs/Exterior/residential building")

# Sorts after existing folders (abu…, awad…, hamada…, luay…, ruba…)
projects = [
    ("zz ab building 07", "07", "A.B BUILDING", "Jaljulia · 2026"),
    ("zz hag 1213 08", "08", "HAG 1213", "Jaljulia · 2026"),
]
...
def make_image(order: str, title: str, meta: str, variant: int) -> Image.Image:
    ...
    draw.rectangle(
        [140 + variant * 30, 160, 640, 900],
        fill=PANEL,
        outline=(60, 56, 48),
        width=1,
    )
    draw.rectangle(
        [560 + variant * 20, 240, 1500, 920],
        outline=(70, 64, 54),
        width=2,
    )
    ...
    draw.text((margin + 36, h // 2 + 50), meta, font=meta_font, fill=MUTED)
    draw.text(
